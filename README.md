...
This repository contains geospatial tools for processing the mangrove potential map from digishape project. The workflow processes various geospatial datasets to create mangrove potential maps and underlying layers that assess the suitability of areas for mangrove restoration.
