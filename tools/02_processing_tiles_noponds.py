...
from general_utilities import (
    ...
    add_country_info,
    get_gmw_external_tiles,
    get_gmw_external_tiles_ids,
    get_tiles_vector,
...
gmw_filtered = get_gmw_external_tiles(gmw_tiles, clark_gmw_tiles_country)
normalized_ids = get_gmw_external_tiles_ids(gmw_filtered, global_tiles, output_dir)

if analysis_id == "200":
    normalized_ids = normalized_ids[:200]
elif analysis_id == "400":
    normalized_ids = normalized_ids[200:400]
elif analysis_id == "600":
    normalized_ids = normalized_ids[400:600]
elif analysis_id == "800":
    normalized_ids = normalized_ids[600:]
else:
