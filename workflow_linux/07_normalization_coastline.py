...
for tile_path in glob.glob(os.path.join(tiles_dir, '*_0.geojson')):
    ...
    coa_500   = os.path.join(coastline_dir, f"COA_{tile_id}_500.tif")
    coa_2500  = os.path.join(coastline_dir, f"COA_{tile_id}_2500.tif")
    coa_5000  = os.path.join(coastline_dir, f"COA_{tile_id}_5000.tif")
    coa_7500  = os.path.join(coastline_dir, f"COA_{tile_id}_7500.tif")

    coa_500_r   = os.path.join(coastline_dir, f"COA_{tile_id}_500_r.tif")
    coa_2500_r  = os.path.join(coastline_dir, f"COA_{tile_id}_2500_r.tif")
    coa_5000_r  = os.path.join(coastline_dir, f"COA_{tile_id}_5000_r.tif")
    coa_7500_r  = os.path.join(coastline_dir, f"COA_{tile_id}_7500_r.tif")

    coa_500_f   = os.path.join(coastline_dir, f"COA_{tile_id}_500_f.tif")
    coa_2500_f  = os.path.join(coastline_dir, f"COA_{tile_id}_2500_f.tif")
    coa_5000_f  = os.path.join(coastline_dir, f"COA_{tile_id}_5000_f.tif")
    coa_7500_f  = os.path.join(coastline_dir, f"COA_{tile_id}_7500_f.tif")

    add_raster = os.path.join(coastline_dir, f"ADC_{tile_id}.tif")
    nor_raster = os.path.join(coastline_dir, f"NOC_{tile_id}.tif")
    com_raster = os.path.join(coastline_dir, f"PRC_{tile_id}.tif")
