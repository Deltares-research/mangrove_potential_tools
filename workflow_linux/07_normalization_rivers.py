...
for tile_path in glob.glob(os.path.join(tiles_dir, '*_0.geojson')):
    ...
    ove_250 = os.path.join(rivers_dir, f"OVE_{tile_id}_250.tif")
    ove_500 = os.path.join(rivers_dir, f"OVE_{tile_id}_500.tif")
    ove_2500 = os.path.join(rivers_dir, f"OVE_{tile_id}_2500.tif")

    ove_250_r = os.path.join(rivers_dir, f"OVE_{tile_id}_250_r.tif")
    ove_500_r = os.path.join(rivers_dir, f"OVE_{tile_id}_500_r.tif")
    ove_2500_r = os.path.join(rivers_dir, f"OVE_{tile_id}_2500_r.tif")

    ove_250_f = os.path.join(rivers_dir, f"OVE_{tile_id}_250_f.tif")
    ove_500_f = os.path.join(rivers_dir, f"OVE_{tile_id}_500_f.tif")
    ove_2500_f = os.path.join(rivers_dir, f"OVE_{tile_id}_2500_f.tif")

    add_raster = os.path.join(rivers_dir, f"ADR_{tile_id}.tif")
    nor_raster = os.path.join(rivers_dir, f"NOR_{tile_id}.tif")
    com_raster = os.path.join(rivers_dir, f"PRR_{tile_id}.tif")
